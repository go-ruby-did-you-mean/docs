...
`go-ruby-did-you-mean/did-you-mean` reimplements Ruby's [`did_you_mean`](https://docs.ruby-lang.org/en/master/DidYouMean.html) in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-did-you-mean/did-you-mean` directly, with no Ruby runtime;
